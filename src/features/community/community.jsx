...
//                         >
//                           <AvatarImage
//                             src={post.author.imageUrl || "/image.png"}
                  ...
                  <Card className="bg-white dark:bg-gray-800">
                    <CardContent className="pt-4">
                      <div className="flex items-center space-x-4 mb-2">
                        <Avatar
                          className="h-10 w-10 cursor-pointer"
                          onClick={() => post.author && showUserProfile(post.author._id)}
                        >
                          <AvatarImage
                            src={post.author?.imageUrl || "/image.png"}
                    ...
                    <CardFooter className="flex justify-between pt-2">
                      <Button
                        ...
                        className={`text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 ${post.likes.includes(user?._id)
                            ? "text-blue-600 dark:text-blue-400"
                            : ""
                          }`}
                      >
