...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      <div className="hidden lg:flex lg:w-1/2 bg-[#3F3FF3] flex-col justify-center items-center p-12">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        ...
        >
          ...
          <p className="text-xl mb-8 text-blue-100">Start Your Journey to Professional Success</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          <Card className="bg-white shadow-lg border-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    required
                    className="bg-gray-50 border-gray-300 focus:border-[#3F3FF3] focus:ring-[#3F3FF3]"
                  />
                </div>
                <div className="space-y-2">
            ...
            <CardFooter>
              <Button
                className="w-full bg-[#3F3FF3] hover:bg-[#2F2FD3] text-white font-semibold"
                type="submit"
                onClick={handleSubmit}
                disabled={isLoading}
              >
